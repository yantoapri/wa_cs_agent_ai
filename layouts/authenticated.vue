      ...
      <div class="border-t border-gray-200 p-4">
        <div class="relative flex justify-center">
          ...
          <div v-if="dropdownOpen" class="absolute left-full ml-2 top-0 w-40 border border-gray-200 rounded-lg shadow-lg z-50 bg-white">
            <NuxtLink class="block w-full text-left px-4 py-2 text-gray-700 hover:bg-gray-50" to="/doc">Dokumentasi</NuxtLink>
            <button class="block w-full text-left px-4 py-2 text-red-600 hover:bg-gray-50" @click="handleLogout">Keluar</button>
          </div>
        </div>
      </div>
    </aside>
        ...
        <div class="border-t border-gray-200 p-4 bg-white">
          <div class="relative">
            ...
            <div v-if="dropdownOpen" class="absolute bottom-full left-0 right-0 mb-2 border border-gray-200 rounded-lg shadow-lg z-50 bg-white">
              <NuxtLink class="block w-full text-left px-4 py-2 text-gray-700 hover:bg-gray-50" to="/doc" @click="closeMobileSidebar">Dokumentasi</NuxtLink>
              <button class="block w-full text-left px-4 py-2 text-red-600 hover:bg-gray-50" @click="handleLogout">Keluar</button>
            </div>
          </div>
        </div>
...
const baseTabs = [
  { value: 'dashboard', label: 'Dasbor', icon: `<svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 13h8V3H3v10zm0 8h8v-6H3v6zm10 0h8V11h-8v10zm0-18v6h8V3h-8z"/></svg>` },
  { value: 'inbox', label: 'Kotak Masuk', icon: `<svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M20 13V6a2 2 0 00-2-2H6a2 2 0 00-2 2v7m16 0v5a2 2 0 01-2 2H6a2 2 0 01-2-2v-5m16 0h-2.586a1 1 0 00-.707.293l-2.414 2.414a1 1 0 01-.707.293h-3.172a1 1 0 01-.707-.293l-2.414-2.414A1 1 0 006.586 13H4"/></svg>` },
  ...
  { value: 'chanel', label: 'Kanal', icon: `<svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 8h2a2 2 0 012 2v6a2 2 0 01-2 2h-2v4l-4-4H9a1.994 1.994 0 01-1.414-.586m0 0L11 14h4a2 2 0 002-2V6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2v4l.586-.586z"/></svg>` },
  { value: 'chat', label: 'Obrolan', icon: `<svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 12h.01M12 12h.01M16 12h.01M21 12c0 4.418-4.03 8-9 8a9.863 9.863 0 01-4.255-.949L3 20l1.395-3.72C3.512 15.042 3 13.574 3 12c0-4.418 4.03-8 9-8s9 3.582 9 8z"/></svg>` },
  ...
  { value: 'my-profile', label: 'Profil Saya', icon: `<svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z"/></svg>` },
]

const adminTabs = [
  { value: 'dashboard', label: 'Dasbor', icon: `<svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 13h8V3H3v10zm0 8h8v-6H3v6zm10 0h8V11h-8v10zm0-18v6h8V3h-8z"/></svg>` },
  { value: 'manage-user', label: 'Kelola Pengguna', icon: `<svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14c-4 0-7 2-7 5v1h14v-1c0-3-3-5-7-5z"/></svg>` },
  { value: 'manage-package', label: 'Kelola Paket', icon: `<svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M20 12l-8 4-8-4m16 0l-8-4-8 4m0 0v6l8 4 8-4v-6"/></svg>` },
